...
public class VerDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Visaulización de Datos");
    ...
    public void cargarTabla() {
        ...
        if (listaMascotas != null) {
            for (Mascota listaMascota : listaMascotas) {
                Object[] objeto = {
                    listaMascota.getNum_cliente(),
                    listaMascota.getNombre(),
                    listaMascota.getColor(),
                    listaMascota.getRaza(),
                    listaMascota.getAlergico(),
                    listaMascota.getAtencion_especial(),
                    listaMascota.getUnDuenio().getNombre(),
                    listaMascota.getUnDuenio().getCelDuenio()
                    };
